...
The shadcn-svelte and official Svelte AI skills are installed locally in `.agents/skills` and recorded in `skills-lock.json`. They are scoped to this repository; no global skill install is required.
